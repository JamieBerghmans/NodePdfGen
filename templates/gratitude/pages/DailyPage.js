...
export class DailyPage {
    ...
    build(monthIndex, dayIndex, homePage) {
        ...
        // Draw dotted lines in loop
        for (let i = 0; i < 5; i++) {
            pdf.setLineWidth(0.8);
            pdf.setLineDashPattern([1, 2], 0);
            pdf.line(x + lineMarginX, y + lineMarginTop + (i * lineSpacing), x + blockWidth - lineMarginX, y + lineMarginTop + (i * lineSpacing));
        ...
        for (let i = 0; i < 5; i++) {
            pdf.setLineWidth(0.8);
            pdf.setLineDashPattern([1, 2], 0);
            pdf.line(x + lineMarginX, y + lineMarginTop + (i * lineSpacing), x + cfg.usableWidth - lineMarginX, y + lineMarginTop + (i * lineSpacing));
            pdf.setLineDashPattern(0);
            pdf.setLineWidth(0.1);
        }
    }
